...
| 완료 | Next.js 16·React 19 업그레이드 | 웹 워크스페이스를 Next.js 16.2.10·React 19.2.7로 전환. ESLint Flat Config, 사전 route type 생성, Node.js 20.9+ 실행 기준, Next.js 16 스크롤 동작을 반영하고 typecheck·Turbopack build·lint 검증 완료 |
