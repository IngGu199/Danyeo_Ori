...
const services = [[GameController, "미니게임", "/games"], [Sparkle, "전국 축제", "/festivals"], [CalendarBlank, "축제 달력", "/calendar"], [ChatCircleDots, "현장 후기", "/community"], [Compass, "여행 코스", "/festivals"], [Wallet, "마일리지", "/games"], [MapTrifold, "축제 지도", "/festivals"], [Ticket, "내 티켓", "/#pre-register"]] as const;
const journey = [
