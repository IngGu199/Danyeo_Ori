...
function authErrorMessage(message: string) {
  ...
  if (message.includes("Email not confirmed")) return "계정 활성화 설정을 확인하지 못했습니다. 관리자에게 문의해 주세요.";
  ...
  async function submit(event: FormEvent<HTMLFormElement>) {
    ...
    if (isSignup) {
      ...
      if (error) {
        ...
        setMessage("계정은 생성되었지만 로그인 세션을 시작하지 못했습니다. 잠시 후 다시 로그인해 주세요.");
      }
    } else {
