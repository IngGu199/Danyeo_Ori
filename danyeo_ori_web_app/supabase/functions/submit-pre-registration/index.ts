...
Deno.serve(async (request) => {
  ...
  try {
    ...
    if (!body.festivalId || !body.consentVersion) throw new HttpError(400, "필수 입력값이 없습니다.");
    ...
    if (error) {
      ...
      await service.rpc("internal_record_security_event", {
        p_user_id: null,
        p_subject_ref: body.festivalId,
        p_ip_prefix_hash: prefixHash,
        p_event_type: "pre_registration",
